...
function onCreate()
	...
	makeLuaSprite('star','BG/who/starBG', 0, 0)
	...
	makeLuaSprite('KILLYOURSELF','BG/who/KILLYOURSELF', 400, 100)
	...
	makeLuaSprite('angrydude','BG/who/mad mad dude', -300, 200)
	...
	makeLuaSprite('Name','WHO', -500, 100)
	addLuaSprite('Name')
