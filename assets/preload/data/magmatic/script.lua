...
function onCreate()
	...
	makeLuaSprite('Name','magmatic', -500, 100)
	addLuaSprite('Name')
...
function onStepHit()
   ...
   if curStep == 160 or curStep == 9999 then
   beating = true
   end
   if curStep == 1056 or curStep == 9999 then
   beating = false
   end
   if curStep == 800 or curStep == 928 or curStep == 9999 then
   flash()
   end
   if curStep == 160 or curStep == 800 or curStep == 9999 then
   cuton()
   end
   if curStep == 32 or curStep == 416 or curStep == 1056 then
   cutoff()
   end
   if curStep == 800 or curStep == 9999 then
   xx = 200; 
   xx2 = 200;
   triggerEvent('Camera Follow Pos',xx,yy)
   end
   if curStep == 1056 or curStep == 9999 or curStep == 9999 then
   xx = -100; 
   xx2 = 400;
   triggerEvent('Camera Follow Pos',xx,yy)
   end
