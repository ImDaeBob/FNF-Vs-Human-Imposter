...
function onCreate()
	...
	makeLuaSprite('Name','aka', -500, 100)
	addLuaSprite('Name')
...
function onStepHit()
   ...
   if curStep == 256 or curStep == 448 or curStep == 960 or curStep == 1280 then
   beating = true
   end
   if curStep == 384 or curStep == 640 or curStep == 1152 then
   beating = false
   end
   if curStep == 256 or curStep == 960 or curStep == 1280 then
   flash()
   end
   if curStep == 384 or curStep == 960 or curStep == 1240 then
   cuton()
   end
   if curStep == 256 or curStep == 448 or curStep == 1152 then
   cutoff()
   end
   if curStep == 128 or curStep == 384 or curStep == 960 then
   xx = 200; 
   xx2 = 200;
   triggerEvent('Camera Follow Pos',xx,yy)
   end
   if curStep == 241 or curStep == 448 or curStep == 1152 then
   xx = -100; 
   xx2 = 400;
   triggerEvent('Camera Follow Pos',xx,yy)
   end
