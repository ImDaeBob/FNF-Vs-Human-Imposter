...
function onCreate()
	...
	makeLuaSprite('Name','assassin', -500, 100)
	addLuaSprite('Name')
...
function onStepHit()
   ...
   if curStep == 1616 or curStep == 9999 then
   beating = false
   end
   if curStep == 799 or curStep == 1360 or curStep == 1552 then
   flash()
   end
   if curStep == 272 or curStep == 464 or curStep == 1360 then
   cuton()
   end
   if curStep == 128 or curStep == 530 or curStep == 1424 then
   cutoff()
   end
   if curStep == 272 or curStep == 464 or curStep == 1360 then
   xx = 200; 
   ...
   if curStep == 336 or curStep == 530 or curStep == 1424 then
   xx = -100; 
   xx2 = 400;
   triggerEvent('Camera Follow Pos',xx,yy)
   end
